...
def draw():
    ...
    for i in range(nc):
        for j in range(nc):
            ...
            match (rnd):
                case 0:
                    py5.triangle(x + width, y, x + width, y + height, x, y + height)
                case 1:
                    py5.triangle(x, y, x + width, y, x, y + height)    
                case 2:
                    py5.triangle(x, y, x + width, y + height, x, y + height)
                case 3:
                    py5.triangle(x, y, x + width, y, x + width, y + height)
